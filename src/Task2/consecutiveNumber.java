...
public class consecutiveNumber {
    public void consecutive(int num) {
      /*  3.Numbers -- print consecutive numbers
        ...
        by more than one of the numbers: 2,3 or 5, it should be replaced by a concatenation of
        the respective words Codility, Test and Coders in this given order. For example, numbers
